export default async function handler(req, res) {
  ...
  const CATEGORY_TYPE_MAP = {
    culture: ["tourist_attraction", "historical_landmark", "cultural_landmark", "historical_place", "art_gallery", "market", "farmers_market", "cultural_center"],
  ...
  try {
    ...
    // Culture explicitly optimizes for delight over completeness — a
    ...
    // category is for.
    const filtered = category === "culture"
