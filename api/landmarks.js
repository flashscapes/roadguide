export default async function handler(req, res) {
  ...
  const CATEGORY_TYPE_MAP = {
    film: ["historical_landmark", "historical_place", "cultural_landmark", "museum", "history_museum", "art_museum", "cultural_center", "performing_arts_theater", "television_studio", "tourist_attraction", "tour_agency", "event_venue"],
  ...
  try {
    ...
    let scored = merged
      ...
      .map((place) => {
        ...
        //        weight (each max +3, floors at 0) per explicit
        ...
        const funBonus = isFun ? 3 : 0; // matches proximityBonus's max — "equal weight to nearest to me"
