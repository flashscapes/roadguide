  ...
  try {
    ...
    const scoredCandidates = merged
      ...
      .map((place) => {
        ...
        // funInformative: kept the existing type-based signal and
        // layered on outdoorSeating (present on most listings) as a
        // broader "fun" signal — a patio/outdoor spot reads as more
        // casually social regardless of exact category.
