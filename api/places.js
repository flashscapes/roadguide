...
export default async function handler(req, res) {
  ...
  // Hard-excluded — Google occasionally tags convenience stores and
  // gas-station coffee counters (e.g. 7-Eleven) with a secondary
  // "cafe" type, which otherwise slips past includedTypes below.
  // Same reasoning/pattern as the car_dealer/car_repair/car_rental/
  // car_wash exclusion already used in landmarks.js. Applies to both
  // Coffee and Bar/Food — a gas station could just as easily sneak
  // into Bar/Food via a mis-tagged secondary type.
  const EXCLUDED_TYPES = new Set([
    "convenience_store", "gas_station", "supermarket",
    "grocery_store", "liquor_store", "discount_store"
  ]);
