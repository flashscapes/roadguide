  ...
  try {
    ...
    const scoredCandidates = places
      ...
      .map((place) => {
        ...
        // raw review volume alone dictate the outcome. In "hidden"
        // mode review volume barely counts at all, same as before.
        const reviewScore = Math.log10(reviewCount + 1);
        const qualityScore = hiddenMode
        ...
        const tierScore = qualityScore + proximityTiebreak;
