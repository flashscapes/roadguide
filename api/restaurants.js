  ...
  try {
    ...
    const scoredCandidates = places
      ...
      .map((place) => {
        ...
        // funInformative (now labeled "Cultural" in the UI): kept the
        // existing cuisine-type signal (which does have reasonable
        // real-world coverage, since Google tags specific cuisines
        // fairly often) and layered on `reservable` — present across
        // most listings — as a second, broader signal. A specific
        // ethnic cuisine or a reservable, sit-down place both read as
        // more of a deliberate "cultural" experience than a generic
        // or fast-food type; outdoor seating reads as more casually
        // "fun".
