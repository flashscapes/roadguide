  ...
  try {
    ...
    const response = await fetch(url, {
      ...
      headers: {
        ...
        "X-Goog-FieldMask":
          "places.id,places.displayName,places.formattedAddress,places.location,places.rating,places.userRatingCount,places.priceLevel,places.businessStatus,places.googleMapsUri,places.websiteUri,places.types,places.outdoorSeating,places.reservable,places.delivery,places.takeout,places.currentOpeningHours.openNow"
      },
    ...
    const restaurants = places
      ...
      .map((place) => {
        ...
        return {
          ...
          // Fields used to build the 3-bullet Restaurant Snapshot.
