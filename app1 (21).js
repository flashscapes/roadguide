...
(function addWorldLandmarksChip() {
  ...
  // 5th chip — after "All", "Restaurants", "Coffee Shops", "Bar/Food".
  catScroll.insertBefore(btn, catScroll.children[4] || null);
})();
...
function setCat(cat, el) {
  ...
  if (cat === 'restaurants' || cat === 'worldlandmarks' || cat === 'coffee' || cat === 'bar') {
    ...
    else if (cat === 'worldlandmarks') loadWorldLandmarks();
...
function getFiltered() {
  ...
  if (activeCategory === 'restaurants' || activeCategory === 'worldlandmarks' || activeCategory === 'coffee' || activeCategory === 'bar') return [];
