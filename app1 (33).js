...
function getFiltered() {
  ...
  if (activeCategory === 'restaurants' || activeCategory === 'coffee' || activeCategory === 'bar' || activeCategory === 'coolstuff' || activeCategory === 'hookmeup') return [];
...
function hookMeUpFetchCategory(categoryParam) {
  var url = 'https://roadguide-lime.vercel.app/api/landmarks?category=' + encodeURIComponent(categoryParam)
          + '&lat=' + encodeURIComponent(userLat) + '&lng=' + encodeURIComponent(userLon) + '&radius=24140';
