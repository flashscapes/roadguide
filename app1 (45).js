...
function openPreferencesOverlay() {
  var overlay = document.getElementById('preferencesOverlay');
  if (overlay) overlay.style.display = 'flex';
}

function closePreferencesOverlay(event) {
  if (event && event.target !== document.getElementById('preferencesOverlay')) return;
  var overlay = document.getElementById('preferencesOverlay');
