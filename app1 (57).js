...
//
// Deliberately does NOT call updatePreferencesDoneState() here. The
// chips restoring as selected is correct (they reflect a real saved
// choice), but the Done button lighting up gold purely from restored
// storage — before the user has done anything this session — reads
// as "already done" rather than the intended "you just finished"
// signal. Done now starts neutral every session regardless of how
// many preferences are already saved, and only turns gold once the
// user actively taps a chip (see onPreferenceChipClick).
