...
(function initStoryButton() {
  ...
  // the same mechanism already used for the background music. This
  // replaces the browser's own built-in voice entirely, since iOS
  // blocks web pages from using its better built-in voices anyway.
