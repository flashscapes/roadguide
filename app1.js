...
function setCat(cat, el) {
  ...
  if (cat === 'restaurants' || cat === 'coffee' || cat === 'bar' || cat === 'coolstuff' || cat === 'museum') {
...
function getFiltered() {
  ...
  if (activeCategory === 'restaurants' || activeCategory === 'coffee' || activeCategory === 'bar' || activeCategory === 'coolstuff' || activeCategory === 'museum') return [];
...
function onPos(pos) {
  ...
  if (activeCategory === 'museum') {
    if (!museumLoaded && !museumLoading) loadMuseum();
    return;
  }
  if (!activeCategory) {
